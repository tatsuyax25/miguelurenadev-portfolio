...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-gray-900 dark:bg-black text-white relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 opacity-40">
        <div className="absolute bottom-6 left-10 font-mono text-sm text-cyan-300 transform rotate-12 animate-pulse">
          &lt;/html&gt;
        </div>
        <div className="absolute top-6 right-10 font-mono text-sm text-green-300 transform -rotate-12 animate-bounce">
          console.log("Thanks!");
        </div>
        <div className="absolute top-1/2 left-1/4 w-4 h-4 bg-cyan-300 rounded-full animate-ping"></div>
        <div className="absolute bottom-1/3 right-1/4 w-3 h-3 bg-blue-400 rounded-full animate-pulse"></div>
        <div className="absolute top-1/4 right-1/3 font-mono text-sm text-purple-300 animate-pulse">
          {"{ }"}
        </div>
        <div className="absolute bottom-1/4 left-1/3 w-2 h-12 bg-gradient-to-t from-transparent to-cyan-300 animate-pulse"></div>
      </div>
